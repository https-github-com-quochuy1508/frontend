  ...
  return (
    <View>
        ...
        <View style={styles.infoWrap}>
            ...
            <Text style={{color: Colors.AZURE91, alignSelf: 'center', fontWeight: 'bold', fontSize: 15}}>
        ...
        <Pressable
            ...
            onTouchEnd={() => setPress(0)}
            onPressOut={() => setPress(0)}>
            <Text style={{alignSelf: 'center', fontSize: 15, fontWeight: 'bold'}}>Xem tất cả bạn bè</Text>
        </Pressable>
