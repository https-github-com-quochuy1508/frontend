  ...
  return (
    <View>
        ...
        <View style={styles.modalContent}>
          <View style={styles.info}>
            ...
            <View>
              ...
              <Text style={{color: Colors.DARKGRAY, fontSize: 15}}>
                Là bạn bè từ tháng 11 năm 2019
              </Text>
            </View>
          </View>
          ...
          <Pressable
            ...
            <View>
              ...
              <Text style={styles.detailText}>
                Nguyễn sẽ không thể nhìn thấy bạn hoặc liên hệ với bạn trên
                Fakebook.
              </Text>
            </View>
          </Pressable>
          <Pressable
            ...
            />
            <View>
              <Text style={[styles.actionText, {color: Colors.REDPINK}]}>
                Hủy kết bạn với Nguyễn
              </Text>
              <Text style={styles.detailText}>
                Xóa nguyễn khỏi danh sách bạn bè.
              </Text>
            </View>
          </Pressable>
        </View>
      ...
      <Modal
        ...
        <View style={styles.deleteContainer}>
          ...
          <Text style={{color: Colors.BLACK}}>
            ...
            sách bạn bè hoặc xem nội dung của bạn đăng trên dòng thời gian của
            mình nữa. Nếu bạn đang chặn ai đó khi hai người đang là bạn bè thì
            hành động này cũng sẽ hủy kết bạn với họ.
          </Text>
          <View
            style={{
              flexDirection: 'row',
      ...
      <Modal
        ...
        <View style={styles.deleteContainer}>
          <Text style={{fontSize: 16, marginBottom: 20, fontWeight: 'bold'}}>
            Hủy kết bạn với Nguyễn Hồng Phương
          </Text>
          <Text style={{color: Colors.BLACK}}>
            Bạn có chắc chắn muốn xóa Nguyễn khỏi danh sách bạn bè không?.
          </Text>
          <View
            style={{
              flexDirection: 'row',
