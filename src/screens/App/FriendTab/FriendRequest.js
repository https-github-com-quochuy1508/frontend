        ...
        <View>
                ...
                <View style={{flexDirection: 'row', paddingVertical: 10}}>
                    ...
                    <View style={{justifyContent: 'center'}}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            >
                                <Text style={{fontWeight: "bold", color: Colors.WHITE}}>Chấp nhận</Text>
                            </TouchableHighlight>
                            <TouchableHighlight 
                            ...
                            >
                                <Text style={{fontWeight: "bold", color: Colors.BLACK}}>Xóa</Text>
                            </TouchableHighlight>
                        </View>
                    </View>
                </View>
            ...
            >
                <View style={styles.deleteContainer}>
                    <Text style={{fontSize: 18, marginBottom: 20}}>Chấp nhận lời mời kết bạn?</Text>
                    <Text style={{fontSize: 15 ,color: Colors.DARKGRAY}}>Bạn chắc chắn muốn thêm người ngày làm bạn bè trên Fakebook.</Text>
            ...
            >
                <View style={styles.deleteContainer}>
                    <Text style={{fontSize: 18, marginBottom: 20}}>Xóa lời mời kết bạn?</Text>
                    <Text style={{fontSize: 15 ,color: Colors.DARKGRAY}}>Bạn chắc chắn không muốn thêm người ngày làm bạn bè trên Fakebook.</Text>
                    <View style={{flexDirection: 'row', justifyContent: 'flex-end', marginTop: 10}}>
                        <TouchableHighlight 
                            style={styles.deleteAction} 
                            underlayColor={Colors.GRAY91}
