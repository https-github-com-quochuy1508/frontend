  ...
  return (
    <View style={styles.wrap}>
        ...
        {likes > 0 || isLike ? (
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <Text style={styles.likeNum}>
              {isLike ? 'Bạn và ' + likes + ' người khác' : likes}
            </Text>
          </View>
        ) : null}
        {comments ? <Text style={styles.likeNum}>{' bình luận'}</Text> : null}
      </View>
      ...
      <Modal
        ...
        swipeDirection="down">
        <Comment liked={isLike} countLike={likes} comments={comments} />
      </Modal>
      <Modal
      ...
      <Modal
        ...
        <View style={styles.blockContainer}>
          ...
          <Text style={styles.happenText}>
            Điều sẽ diễn ra với {userInfo && userInfo.name.split(' ')[0]}
          </Text>
          <View style={styles.happenContainer}>
            <Image
              source={{
            ...
            />
            <Text style={styles.happenContent}>
              Dù không biết là đã bị chặn nhưng{' '}
              {userInfo && userInfo.name.split(' ')[0]} sẽ không xem được trang
              cá nhân của bạn, gắn thẻ bạn trong bài viết, nhắn tin hay thêm bạn
              làm bạn bè.
            </Text>
          </View>
      ...
      <Modal
        ...
        <Text style={styles.help}>
          Ý kiến đóng góp của bạn giúp hệ thống của chúng tôi biết khi có gì đó
          không ổn.
        </Text>
